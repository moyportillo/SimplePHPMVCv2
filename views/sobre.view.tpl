...
<div>
    ...
    <p>
        "Nuestra Empresa esta desarrollada para ofrecerles a nuestros clientes y colaboradores una experiencia resultante a
         la hora de ofertar y mostrar un producto, con el objetivo de mostrar de una forma mas sencilla y ejemplificada las
...
<div>
    <h2>Comprar en cualquier lugar</h2>
